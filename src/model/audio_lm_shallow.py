...
@dataclass
class AudioLanguageShallowConfig(AudioLanguageModelConfig):
    name:str = 'shallow_fusion'
...
class AudioLanguageShallowModel(AudioLanguageModel):
    def __init__(self, model_cfg:AudioLanguageShallowConfig, ad_cfg:AudioFeatureConfig, lm_cfg:LanguageFeatureConfig, label_cfg:LabelPreprocessConfig):
        super(AudioLanguageShallowModel, self).__init__(model_cfg, ad_cfg, lm_cfg, label_cfg)
